...
flash char FHandContr[]={"SYHND 00027"};                    // Get Handle Controller
...
unsigned long KZU[8]={0x7D534B24,0xCEA938F7,0x3DAD2F30,0xD58673D1,  // KEY
                      0xCB7BC7B0,0xAFE4C892,0xFA885DA0,0xFA6A5E2F};   
